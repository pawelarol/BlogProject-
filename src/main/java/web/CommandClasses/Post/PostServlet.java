...
//    }
//
//    private PostResponse createPost(HttpServletRequest req) throws UnsupportedEncodingException {
...
//        req.setCharacterEncoding("UTF-8");
//
//        PostResponse blogReq = createPost(req);
//        try {
//
//            PostResponse postResponse = dao.addPost(blogReq);
//
...
//
//
//        PostResponse post = createPost(req);
//        // узнать как получать список комментариев к посту
//
//        try {
//            PostResponse ans = dao.getPost(post.getTitle());
//
//                if (ans != null) {
...
//
//            PostResponse request = createPost(req);
//
//            try{
//                PostResponse blogPostResponse = dao.deletePost(request);
//                PrintWriter out = resp.getWriter();
//
